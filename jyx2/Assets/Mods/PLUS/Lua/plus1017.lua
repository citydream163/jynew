Talk(0, "我在这游戏里共度过<color=red>"..Calendar(2).."</color>天，胡混了<color=yellow>"..Calendar(3).."</color>天，战斗了<color=blue>"..Calendar(4).."</color>场，休息了<color=green>"..Calendar(5).."</color>天。", "", 1);
