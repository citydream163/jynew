Talk(11, "不知小兄弟是哪派的高徒，其他五派的人呢？", "", 0);
Talk(0, "在下并非六大派的人，此次前来明教是想打听一本书的下落。", "", 1);
Talk(11, "是《<color=#A564DB>倚天屠龙记</color>》吧？", "", 0);
Talk(0, "江湖上传言果然非假，《<color=#A564DB>倚天屠龙记</color>》一书果然在明教中。不知前辈可否借小弟一用。", "", 1);
Talk(11, "借你一用。哼！你没将明教光明左使<color=Yellow>杨逍</color>瞧在眼里，是不是仗着我明教大难之际来捡现成便宜？", "", 0);
Talk(0, "事情并非如此，实在是这本书对我十分重要，我非得到它不可。", "", 1);
Talk(11, "那我就先把你解决再说，免得六大派攻来后被你混水摸鱼了。", "", 0);
Talk(0, "我并不是来与明教为难的，杨左使还是留点气力对付六大派好了。", "", 1);
Talk(11, "对付你倒也不用花费什么力气。出招吧！", "", 0);
...
::label0::
    ...
    LightScence();
    Talk(0, "杨左使，我就说了嘛，跟我打很耗力气的。", "", 1);
    Talk(11, "你……", "", 0);
    Talk(18, "哈！哈！哈！打的好，打的好。", "", 0);
    Talk(0, "哪里来的贼秃在那鬼吼鬼叫的。", "", 1);
    Talk(11, "你是谁？是怎么混进我明教的？", "", 0);
    Talk(18, "你问我<color=Yellow>成昆</color>怎么进来的？当然是大摇大摆走进来的。还多亏了这小朋友，替我省下一番功夫。", "", 0);
    Talk(11, "你是混元霹雳手<color=Yellow>成昆</color>，谢法王的师父？", "", 0);
    Talk(18, "没错，我就是那头笨狮的师父。拜他的鲁莽所赐，你们和六大派结下了这么多梁子。今天起明教就将化为灰烬，也了结了我多年来的心愿。", "", 0);
    Talk(0, "要是我猜的没错，这中间的一切都是你苦心安排的。", "", 1);
    Talk(18, "你这小子倒还蛮聪明的嘛。没错，激起<color=Yellow>谢逊</color>的愤怒，让他到处乱杀人，留下我的名字好激我现身，到最后再故意让江湖人知道其实是明教<color=Yellow>谢逊</color>所为，引起江湖各大派与明教间仇杀，这一切都是我精心计划的。", "", 0);
    Talk(11, "你为何要如此做？", "", 0);
    Talk(18, "要问就去问你们前任教主阳顶天。我原本一桩美好的姻缘却被他活生生拆散了，明明是我爱妻，只因他当上了魔教的大头子，就将我爱妻霸占了去。因此我心中便立下重誓：只要我成昆还有一口气在，定要让魔教永无宁日。", "", 0);
	Talk(18, "我立下此誓已有二十余年，今日方见大功告成。哈哈！现下六大派应该已攻下总坛<color=Red>光明顶</color>了吧。", "", 0);
    Talk(11, "什么！那我得快点赶回<color=Red>光明顶</color>。", "", 0);
    Talk(18, "不用赶回去死了，你死在这就可以了。", "", 0);
    Talk(0, "喂！老秃驴，你们这些恶人怎么每次都喜欢将自己的坏勾当讲出来。是不是以为我们这些好人都会死掉，无法揭发你的阴谋？杨左使，你先赶回<color=Red>光明顶</color>，这个秃驴交给我好了，让他尝尝多嘴的后果。", "", 1);
    Talk(18, "哼！就凭你。", "", 0);
    Talk(11, "你……你……真的行吗？", "", 0);
    Talk(0, "别忘了，如果连我也不行的话，那你可能更惨哦！快去吧，我随后就到。", "", 1);
    AddRepute(4);
...
::label1::
        ...
        Talk(0, "这老贼溜的倒快，没时间追他了，我得赶快赶去<color=Red>光明顶</color>才是。", "", 1);
        
        AddRepute(3);
        ChangeMMapMusic(3);
       ModifyEvent(-2, 15, -2, -2, 2018, -1, -1, -2, -2, -2, -2, -2, -2);--by citydream 启动脚本2018 场景12-编号15
do return end;
