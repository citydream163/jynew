if InTeam(47) == false then goto label0 end;
    Talk(46, "<color=Yellow>阿紫</color>，你居然还敢回来。“<color=#FD726F>神木王鼎</color>”呢？", "", 0);
    jyx2_ReplaceSceneObject("","NPC/阿紫2","1");
::label0::
    Talk(0, "＜怎么长的好像小孩子，莫非真练到返老还童了？＞<color=Yellow>丁春秋</color>，你认得这<color=blue>七宝指环</color>吗？", "", 1);
    Talk(46, "你是谁，怎么会有这东西。", "", 0);
    Talk(0, "见到掌门还不跪下。", "", 1);
    Talk(46, "这逍遥派掌门的信物是哪偷来的？", "", 0);
    Talk(0, "是你师父给的，他还要我们来替他清理门户，除去你这武林败类。", "", 1);
    Talk(46, "那老贼被我打落山崖，居然还没死，竟然还将这<color=blue>七宝指环</color>给了你。也好，你亲自来送死，也免得我去找这<color=blue>七宝指环</color>了。", "", 0);
    Talk(92, "师父功力，震烁古今，你竟敢和我们作对，这叫萤火虫与日月争光！", "", 0);
    Talk(92, "螳臂挡车，自不量力，可笑啊！可笑！", "", 0);
    Talk(92, "我师父谈笑之间，便可将你们这一干妖魔小丑置之死地……", "", 0);
    Talk(0, "你们烦不烦，要打就快打，别在那大吹法螺。", "", 1);
...
::label1::
        ...
        LightScence();
        Talk(0, "好不容易解决了这老怪。", "", 1);
        Talk(92, "少侠英雄无敌，小人忠诚归附，死心塌地，愿为主人效犬马之劳。", "", 0);
        Talk(92, "这天下盟主一席，非少侠莫属。只须主人下令动手，小人赴汤蹈火，万死不辞。", "", 0);
        Talk(92, "<color=Yellow>丁春秋</color>这灯烛之火，居然也敢和日月争光。", "", 0);
        Talk(92, "少侠德配天地，威震当世，古今无比。", "", 0);
        Talk(0, "这些家伙转的真快，不愧是星宿派的弟子。不过听了虽有点肉麻，但也蛮舒服的。", "", 1);
        AddEthics(10);
        AddRepute(6);
do return end;
