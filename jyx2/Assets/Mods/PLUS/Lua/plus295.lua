Talk(0, "看你的样子，你就是那“狗熊野猪”的头头？", "", 1);
Talk(24, "阁下是谁，为何跟我<color=Red>青城派</color>过不去？", "", 0);
Talk(0, "我跟你说，快将林震南前辈放了，否则打你满头包。", "", 1);
Talk(24, "原来是为了林家的事。", "", 0);
Talk(0, "快说，林前辈在哪？", "", 1);
Talk(24, "哼！只怕你见不到他了。", "", 0);
Talk(0, "你将他杀了？", "", 1);
Talk(24, "谁叫他不说出“<color=orange>辟邪剑谱</color>”的下落。", "", 0);
Talk(0, "你好狠毒的心。", "", 1);
Talk(24, "你这么想见他，我就送你去。", "", 0);
...
::label0::
    ...
    Talk(0, "我看起来像会乱杀人的吗？要如何处置你，由林家自己来决定。", "", 1);
