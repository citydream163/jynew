Talk(13, "少侠准备好要破我明教之“光明圣火阵”了吗？", "", 0);
if AskBattle() == true then goto label0 end;
    Talk(0, "我还没准备好。", "", 1);
    do return end;
::label0::
    Talk(0, "我准备好了，还请各位前辈高抬贵手。", "", 1);
...
::label1::
        ...
        LightScence();
        Talk(12, "果然是英雄出少年，我们这些老骨头都不行了。", "", 0);
        Talk(14, "今后武林中，就是你们这些年轻人的天下了。", "", 0);
        Talk(0, "是各位前辈承让了。", "", 1);
        Talk(13, "就遵照我们的约定，《<color=#A564DB>倚天屠龙记</color>》一书该为少侠所有。", "", 0);
        Talk(0, "谢谢各位前辈。在经过了这么多波折才拿到此书，虽说辛苦，但也从中学到不少东西。世上的好坏人真的很难去界定，名门正派的人，外表有羊皮披挂着，反倒是更容易去为恶。", "", 1);
        Talk(10, "经过了这些，你的江湖历练又增长了不少。希望你在其它的旅途上也更能顺利。", "", 0);
        Talk(0, "好了，我还要去忙别的了。有空我会再回来的。", "", 1);
        AddItem(155, 1);
        AddRepute(10);
do return end;
