Talk(0, "莫非这二人竟是阳顶天夫妇？这里有封信，看看写些什么：", "", 1);
Talk(107, "今余神功第四层初成，即悉<color=Yellow>成昆</color>之事，血气翻涌不克自制，真力将散，行当大归。天也命也，复何如耶？今余命在旦夕，有负衣教主重托，实为本教罪人。盼夫人持余亲笔遗书，召聚众人，令<color=Yellow>谢逊</color>暂摄副教主之位，处分本教重务……", "", 0);
Talk(0, "原来阳教主是在练功时，因知悉<color=Yellow>成昆</color>的事后，不慎走火入魔了。而阳教主夫人……这里有把匕首，看来是因愧疚而自杀了。这个羊皮卷，大概就是他当时在练的“神功”吧。", "", 1);
AddItem(92, 1);
