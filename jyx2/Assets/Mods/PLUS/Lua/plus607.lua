Talk(97, "哪里来的小子，敢擅闯我<color=Red>神龙岛</color>。", "", 0);
Talk(0, "<color=Red>神龙岛</color>？听起来好像颇棘手的，我还是下回有把握点再来。", "", 1);
Talk(97, "想走，我<color=Red>神龙岛</color>可不是你说来就来，说走就走的。", "", 0);
Talk(0, "别这样嘛！我船随便开开，就开到你们岛上了。本想看看你们这边有没有我要找的书，但……我看大概没有……打扰了……", "", 1);
Talk(97, "果然是来偷书的。来人呀！快将他拿下。", "", 0);
