Talk(0, "诸位大师，我想进<color=Red>少林寺</color>参观一下，可以吗？", "", 1);
Talk(96, "请施主先将兵刃留下，待下山前我们再归还予你。", "", 0);
Talk(0, "对了，这是<color=Red>少林寺</color>千年下来的传统，以表示对<color=Red>少林寺</color>的尊重。好，我就将兵刃……＜等等，武侠小说中的主角向来都不吃这一套的，若我这么听话，那戏还有什么好看的……＞等会，这兵刃向来不与我离身，我不能将兵刃放下。", "", 1);
Talk(96, "那就请施主下山。", "", 0);
