...
SetRoleFace(1);
Talk(19, "少侠，老夫听说你独自攻上这<color=Red>黑木崖</color>来，特别率我五岳派门徒赶上来帮你。<color=Yellow>东方不败</color>那魔头呢？", "", 0);
Talk(0, "唉！你们怎么跟电影剧情一样，事情都结束后才出现。<color=Yellow>东方不败</color>那个变态家伙，已经被我“干掉”了。", "", 1);
Talk(19, "真是如此！少侠又替我武林正派立了一项大功。", "", 0);
Talk(0, "哪里，哪里。", "", 1);
Talk(19, "那不知少侠是否有看到一本书？", "", 0);
Talk(0, "什么书？", "", 1);
Talk(19, "《<color=#A564DB>笑傲江湖</color>》！", "", 0);
Talk(0, "当然有啊！我辛苦了半天，还不都是为了它。任老头将它送给我了。", "", 1);
Talk(19, "这又是另一项功劳了。少侠真当为我武林同道所敬仰。此书乃是我五岳剑派许多前辈当年拼命所得到的，后来不幸被魔教夺去。我五岳派这几年发奋图强，与魔教周旋到底，为的就是将此书夺回。想不到今日少侠大显神威，从魔教手中将此书夺回，我五岳派全体上下无限感激。现在就请少侠将此书还与我五岳派。", "", 0);
Talk(0, "＜说了半天，原来也是想要《<color=#A564DB>笑傲江湖</color>》这本书＞不过据我所知，这本书的原主人也不是五岳剑派的人。你们前辈只是暂时得到过。今天，我的任务就是要将这些书送回原处，你们以后也不用再为此烦心。更何况这书也不是你们想像中的什么高深武功秘笈，它只不过是本故事书罢了。", "", 1);
Talk(19, "莫非，少侠是想将此书占为己有。还是你已与魔教勾结了？", "", 0);
Talk(0, "岳先生，你别给我乱安罪名了。这书真的不是你们想像中的什么高深武功秘笈，它只不过是本故事书罢了。", "", 1);
Talk(19, "看来少侠入魔已深，非得要逼我们动手不可。", "", 0);
Talk(0, "我看是你<color=Yellow>岳不群</color>入魔已深。那日嵩山大会上我就有点被“耍”的感觉。今天，你为了抢这本《<color=#A564DB>笑傲江湖</color>》又想不择手段。", "", 1);
Talk(0, "今日你怎会突然出现，分明就是早已算计好的，想等我跟<color=Yellow>东方不败</color>鹬蚌相争，你好来个渔翁得利。我看你不是“君子剑”，分明是个“伪君子”！", "", 1);
Talk(19, "你……你说什么！", "", 0);
if InTeam(35) == false then goto label0 end;
    Talk(35, "师父，别再执迷下去了。这书的确不是武功秘笈，只是一本普通的书。", "", 1);
::label0::
    Talk(0, "岳先生，回头是岸。", "", 1);
    Talk(19, "别说这么多的废话，五岳派的人听着，给我杀，今日不留一个活口。", "", 0);
...
::label1::
        ...
        LightScence();
        Talk(0, "想不到在找寻这本书的过程中，让我看到人性中为了争权夺利所展现的丑陋面。", "", 1);
		Talk(0, "不管是正派中的<color=Yellow>左冷禅</color>与<color=Yellow>岳不群</color>，还是邪派中的<color=Yellow>任我行</color>与<color=Yellow>东方不败</color>，都是一样的。", "", 1);
