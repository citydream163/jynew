...
Talk(0, "门总算开了，终于可以回去了。可是，心里面好像怪怪的，总觉得好像少了件什么事……", "", 1);
if JudgeEthics(0, 0, 50) == true then goto label0 end;
    ...
    SetRoleFace(1);
    LightScence();
    Talk(0, "我就知道，每次在结局前，总是少不了一场大混战。", "", 1);
    Talk(67, "小子，你武功那么强，一定是从“十四天书”中领悟到什么奥妙。", "", 0);
    Talk(71, "快将它说出来，否则……", "", 0);
    Talk(0, "否则怎样？你们个个都是小侠我的手下败将，还想怎样？", "", 1);
    Talk(22, "一个人打不过你，那十个人呢？", "", 0);
    Talk(0, "不会吧！你们个个都是武林中有名的夙宿，不会联合起来打我一个人吧？传了出去，你们以后怎么做人？", "", 1);
    Talk(19, "事到如此，还管得了这么许多吗？", "", 0);
    Talk(51, "何况，把你杀了后，也没人会传出去了。", "", 0);
    Talk(62, "别说废话了。动手吧！", "", 0);
...
::label4::
        ...
        LightScence();
        Talk(0, "怎么门又关起来了。这次大概真的结束了。走吧，我得赶快了。", "", 1);
        do return end;
::label0::
        Talk(57, "小子，你想就这样子走了吗？", "", 0);
        Talk(0, "真的发生事情了。", "", 1);
        DarkScence();
        ...
        LightScence();
        Talk(0, "我就知道，每次在结局前，总是少不了一场大混战。", "", 1);
        Talk(69, "在这武林中，你干下了多少坏事。", "", 0);
        Talk(3, "看看你的道德指数吧，你都干了些什么？", "", 0);
        Talk(55, "练武是为了什么？行侠仗义，济弱扶倾的目的你都忘了吗？", "", 0);
        Talk(64, "你在武林中混了这么久，尽学一些坏东西。", "", 0);
        Talk(56, "是我们错了，没能把你教好。", "", 0);
        Talk(70, "但我们也不能让你就这样一走了之。", "", 0);
        Talk(50, "别怪我们出手太重，你留在这世间也只是个祸害。", "", 0);
        Talk(69, "动手吧。", "", 0);
        Talk(70, "阿弥陀佛！", "", 0);
...
::label2::
            LightScence();
            Talk(55, "我们已经尽力了，还是无法消灭你这祸害。", "", 0);
            Talk(70, "阿弥陀佛！这是众生的浩劫呀！", "", 0);
            Talk(69, "杀不了你这个大魔头。唉！或许是天意吧！我们走吧。", "", 0);
            DarkScence();
            ModifyEvent(-2, 25, 0, 0, -1, -1, -1, -1, -1, -1, -2, -2, -2);
            ModifyEvent(-2, 26, 0, 0, -1, -1, -1, -1, -1, -1, -2, -2, -2);
            ModifyEvent(-2, 27, 0, 0, -1, -1, -1, -1, -1, -1, -2, -2, -2);
