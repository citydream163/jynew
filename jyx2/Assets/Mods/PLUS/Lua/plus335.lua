...
::label0::
    ...
    Talk(0, "小兄弟，快将这酒喝下去！", "", 1);
    Talk(38, "我不喜欢喝酒。", "", 0);
    Talk(0, "快喝了他吧！喝下去之后，你就不会忽冷忽热了。", "", 1);
    Talk(38, "真的？那我要喝。", "", 0);
    DarkScence();
    ...
    LightScence();
    Talk(38, "哇！这酒怎么这么辛辣！不过好像真的挺有效的，谢谢你！既然老伯伯不在了，我要去找妈妈跟小黄了。", "", 0);
    if AskJoin () == true then goto label1 end;
        do return end;
::label1::
        Talk(0, "你要找你妈妈？我正好在四处旅行，不妨我们结伴一起走，好吗？", "", 1);
        if TeamIsFull() == false then goto label2 end;
            Talk(38, "你的队伍已满，我无法加入。", "", 0);
            do return end;
::label2::
            Talk(38, "好啊！", "", 0);
            DarkScence();
