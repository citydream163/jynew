...
if HaveItem(138) and  HaveItem(139) and  HaveItem(140) and  HaveItem(141) and  HaveItem(142) then goto labelS end;
	Talk(75, "想要“玉笛谁家听落梅”，就赶紧将<color=#FD726F>羊羔坐臀、小猪耳朵、小牛腰子、獐腿肉、兔肉</color>这五种材料找来。", "", 0);
	do return end;
...
::labelS::
	...
	Talk(75, "好，材料通通都有了，我马上就把“<color=blue>玉笛谁家听落梅</color>”做给你。", "", 0);
	DarkScence();
	...
	LightScence();
	Talk(75, "好了，完成了，这一道“<color=blue>玉笛谁家听落梅</color>”你拿去吧。", "", 0);
	Talk(0, "谢谢林师父。", "", 1);
	AddItem(176, 1);
	do return end;
