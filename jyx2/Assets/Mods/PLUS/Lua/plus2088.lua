...
AddItem(202, math.random(5,10));
IcanFly = 2;
Talk(0,"他跑得太快了，<color=blue>神游券</color>掉了一地。","", 1);
do return end;
::label9::
if HaveItem(202) == true then goto label10 end;
Talk(401,"正所谓生死有命富贵在天，只要小哥大展拳脚，定能……","", 0);
Talk(0,"哎呀呀，这些话我都听腻了，<color=blue>神游券</color>，快把<color=blue>神游券</color>拿来。","", 1);
AddItem(202, 1);
IcanFly = 1;
ModifyEvent(1000, 1, -2, -2, -2, 2087, -2, -2, -2, -2, -2, -2, -2);--河洛客栈树林触发器
ModifyEvent(1000, 3, -2, -2, -2, 2104, -2, -2, -2, -2, -2, -2, -2);--有间客栈树林触发器
ModifyEvent(1000, 40, -2, -2, -2, 2107, -2, -2, -2, -2, -2, -2, -2);--悦来客栈树林触发器
ModifyEvent(1000, 60, -2, -2, -2, 2110, -2, -2, -2, -2, -2, -2, -2);--龙门客栈树林触发器
ModifyEvent(1000, 61, -2, -2, -2, 2113, -2, -2, -2, -2, -2, -2, -2);--高升客栈树林触发器
do return end;
::label10::
Talk(401,"正所谓生死有命富贵在天，只要小哥大展拳脚……","", 0);
AddItem(202, 1);
IcanFly = 1;
Talk(0,"哎呀呀，别啰嗦，快把<color=blue>神游券</color>拿来。","", 1);
do return end;
::label11::
