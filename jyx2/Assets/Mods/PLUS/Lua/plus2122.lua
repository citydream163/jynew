...
--构造数组
arr = {};
arr[1] = {320,247,"客栈住不下了，今晚在这里凑合一宿吧。","闯荡江湖要先去学一门武功。"};--320为原青城211，头像86
arr[2] = {321,248,"这里有户人家，把捉到的毒物先在这里暂放一下。","行走江湖要学会一门抗毒的技能。"};--321为原五毒221，头像87
arr[3] = {322,249,"去海外仙岛路途遥遥，先在这里歇歇脚吧。","可以去海外仙岛学习高深的武功。"};--322为原雪山241，头像90
arr[4] = {323,250,"师父说要去拉人加入咱们的帮派，现在人头难凑啊。","一定要先去找个能说会道的师父。"};--323为原星宿261，头像92
arr[5] = {324,251,"师父说学习武功首要的还是要住在山上，以便他面授机宜。今晚先在这里歇歇脚吧，明早再赶路。","可以去山上找个师父传授武功。"};--324为原泰山201，头像85
arr[6] = {325,252,"五岳剑派同气连枝，这么多人还不够吗？为什么还要找其他人加入呢？","行走江湖需要先去找一两个结拜兄弟。"};--325为原衡山171，头像82
arr[7] = {327,253,"教主说帮派人手不足，来这里看看有没有人愿意加入的。","去岛上找个帮派加入，会受益无穷。"};--327为原神龙101，头像97
arr[8] = {328,254,"拉琴吹箫似乎不是武功啊，为什么师父以琴为剑呢？这里有一株上好的梓木。","最快的升级方法是去山里找株仙草服用。"};--328为原昆仑91，头像78
--arr[9] = {326,250,"内力不济，走路就容易累，先在这里休息一下吧。","学习高深的武功之前先修炼一下内力。"};--326为原崆峒151，头像79
