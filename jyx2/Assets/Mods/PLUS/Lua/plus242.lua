...
::label0::
    ...
    Talk(35, "好一只<color=blue>翡翠杯</color>！得此美酒佳器，人生更有何憾。我<color=Yellow>令狐冲</color>先干为敬，谢谢兄弟赠酒之情。", "", 0);
    ...
    Talk(0, "＜<color=Yellow>令狐冲</color>！他就是<color=Yellow>令狐冲</color>！＞我听江湖上议论纷纷说令狐兄已遭<color=Red>华山派</color>逐出师门，不知可有此事？", "", 1);
    ...
    if AskJoin () == true then goto label1 end;
        ...
        do return end;
::label1::
        Talk(0, "我看不如这样吧。令狐兄就和我一起同游江湖共寻美酒，才不枉此生。", "", 1);
        if TeamIsFull() == false then goto label2 end;
            Talk(35, "你的队伍已满，我无法加入。", "", 0);
            do return end;
::label2::
            Talk(35, "这个提议甚好，咱们就一起喝尽人世间的佳酿美酒，走！对了，兄弟，告诉你一个好玩的地方，是我在华山时发现的。那地方甚为隐密，入口在华山的背面，有空我们可以去看看。", "", 0);
