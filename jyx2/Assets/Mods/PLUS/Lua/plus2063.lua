...
local levnum = math.random(0,100)
local moneynum = math.random(10,100)
local radnum = math.random(1,100)
if levnum > 50 then goto label19 end;
...
do return end;
::label1::
	if JudgeHeal(0,1,30) == false then goto label13 end;--check ok
Talk(0,"走远路需要做好防护。","", 1);
AddHeal(0,1);
do return end;
::label2::
...
do return end;
::label3::
	if JudgeQuanzhang(0,1,30) == false then goto label14 end;--check ok
Talk(0,"嘿嘿哈嘿，边走路边打拳。","", 1);
AddQuanzhang(0,1);
do return end;
::label4::
	if JudgeYujian(0,1,30) == false then goto label15 end;--check ok
Talk(0,"御剑飞升。","", 1);
AddYujian(0,1);
do return end;
::label5::
...
do return end;
::label8::
	if JudgeAttackPoison(0,1,30) == false then goto label16 end;--check ok
Talk(0,"差一点就抓到那只莽牯朱蛤了。","", 1);
AddAttackPoison(0,1);
do return end;
::label9::
	if JudgeQimen(0,1,15) == false then goto label17 end;--check ok
Talk(0,"奇门遁甲用在这里最合适。","", 1);
AddQimen(0,1);
do return end;
::label10::
Talk(0,"出门见财。","", 1);
...
do return end;
::label17::
Talk(0,"也许可以学习一些其他的武功。","", 1);
do return end;
::label18::
Talk(0,"弯弯绕绕，曲曲折折。","", 1);
do return end;
::label19::
ModifyEvent(-2, -2, 0, 0, -1, -1, 2066, -1, -1, -1, -2, -2, -2);
do return end;