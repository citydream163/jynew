...
AddItem(202, math.random(3,7));
IcanFly = 2;
Talk(0,"他跑得太快了，<color=blue>神游券</color>掉了一地。","", 1);
do return end;
::label9::
if HaveItem(202) == true then goto label10 end;
Talk(401,"正所谓生死有命富贵在天，只要小哥大展拳脚，定能有一番大作为。半仙我游遍山南海北，小哥喜欢旅游吧？我送你一张<color=blue>神游券</color>。使用方法：在大地图中客栈附近树林中打开本券，可以神游到任意地方。","", 0);
AddItem(202, 1);
IcanFly = 1;
Talk(0,"这话听着还算顺耳，什么<color=blue>神游券</color>，有那么厉害吗？我去试试看。","", 1);
ModifyEvent(1000, 1, -2, -2, -2, 2085, -2, -2, -2, -2, -2, -2, -2);--河洛客栈树林触发器
ModifyEvent(1000, 3, -2, -2, -2, 2103, -2, -2, -2, -2, -2, -2, -2);--有间客栈树林触发器
ModifyEvent(1000, 40, -2, -2, -2, 2106, -2, -2, -2, -2, -2, -2, -2);--悦来客栈树林触发器
ModifyEvent(1000, 60, -2, -2, -2, 2109, -2, -2, -2, -2, -2, -2, -2);--龙门客栈树林触发器
ModifyEvent(1000, 61, -2, -2, -2, 2112, -2, -2, -2, -2, -2, -2, -2);--高升客栈树林触发器
do return end;
::label10::
Talk(401,"正所谓生死有命富贵在天，只要小哥大展拳脚，定能有一番大作为。我再送你一张<color=blue>神游券</color>。","", 0);
AddItem(202, 1);
IcanFly = 1;
Talk(0,"这话听着还算顺耳，人生一世草木一秋，过自己想要的生活才最重要。","", 1);
do return end;
::label11::
