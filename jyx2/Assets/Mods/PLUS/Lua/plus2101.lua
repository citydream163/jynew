...
::label0::
	Talk(0, "这么一大片桃林啊。", "", 1);
    Talk(63, "家乡的桃树已结实，这里桃花甫开，我要折一枝把玩。问花花不语，为谁落，为谁开？算春色三分，半随流水，半入尘埃。", "", 0);
	Talk(0, "姑娘真是好文采。", "", 1);
	Talk(63, "好久没来桃花岛了，不知师姊过的可好。", "", 0);
	Talk(0, "这扇大门是关着的。", "", 1);
	Talk(63, "师父擅九宫八卦之术，只需依后天八卦配九宫奇门之术，即可开此门。", "", 0);
	Talk(0, "还请姑娘赐教。", "", 1);
	Talk(63, "这八卦按乾☰六、兑☱七、离☲九、震☳三、巽☴四、坎☵一、艮☶八、坤☷二之数；配以洛书九宫合一十五之数当可开此门。", "", 0);
	Talk(0, "六加九为一十五，只要从乾☰门进离☲门出就可以了吧？", "", 1);
	Talk(63, "不是的，中宫数五，不用计算，只要先在其他八门中任选两门合十之数，再走到中宫即可打开此门。", "", 0);
	Talk(0, "这样啊，我来走走看。", "", 1);
