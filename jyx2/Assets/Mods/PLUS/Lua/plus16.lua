...
elseif UseItem(193) == true then goto label193
    ...
    do return end;
::label0::
    Talk(0, "我一定是疯了，才会想把这书烧掉！");
do return end;
::label39::
    Talk(0, "<color=orange>"..PaperScroll(39,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(39,-1);
	AddItem(239,1);	
	AddExp(0,PaperScroll(39,0));
do return end;
::label40::
    Talk(0, "<color=orange>"..PaperScroll(40,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(40,-1);
	AddItem(240,1);
...
do return end;
::label43::
    Talk(0, "<color=orange>"..PaperScroll(43,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(43,-1);
	AddItem(243,1);
	AddExp(0,PaperScroll(43,0));
do return end;
::label44::
    Talk(0, "<color=orange>"..PaperScroll(44,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(44,-1);
	AddItem(244,1);
	AddExp(0,PaperScroll(44,0));
do return end;
::label45::
    Talk(0, "<color=orange>"..PaperScroll(45,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(45,-1);
	AddItem(245,1);
	AddExp(0,PaperScroll(45,0));
do return end;
::label46::
    Talk(0, "<color=orange>"..PaperScroll(46,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(46,-1);
	AddItem(246,1);
	AddExp(0,PaperScroll(46,0));
do return end;
::label47::
    Talk(0, "<color=orange>"..PaperScroll(47,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(47,-1);
	AddItem(247,1);
	AddExp(0,PaperScroll(47,0));
do return end;
::label48::
    Talk(0, "<color=orange>"..PaperScroll(48,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(48,-1);
	AddItem(248,1);
	AddExp(0,PaperScroll(48,0));
do return end;
::label49::
    Talk(0, "<color=orange>"..PaperScroll(49,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(49,-1);
	AddItem(249,1);
	AddExp(0,PaperScroll(49,0));
do return end;
::label50::
    Talk(0, "<color=orange>"..PaperScroll(50,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(50,-1);
	AddItem(250,1);
	AddExp(0,PaperScroll(50,0));
do return end;
::label51::
    Talk(0, "<color=orange>"..PaperScroll(51,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(51,-1);
	AddItem(251,1);
	AddExp(0,PaperScroll(51,0));
do return end;
::label52::
    Talk(0, "<color=orange>"..PaperScroll(52,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(52,-1);
	AddItem(252,1);
	AddExp(0,PaperScroll(52,0));
do return end;
::label53::
    Talk(0, "<color=orange>"..PaperScroll(53,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(53,-1);
	AddItem(253,1);
	AddExp(0,PaperScroll(53,0));
do return end;
::label54::
    Talk(0, "<color=orange>"..PaperScroll(54,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(54,-1);
	AddItem(254,1);
	AddExp(0,PaperScroll(54,0));
do return end;
::label55::
    Talk(0, "<color=orange>"..PaperScroll(55,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(55,-1);
	AddItem(255,1);
	AddExp(0,PaperScroll(55,0));
do return end;
::label56::
    Talk(0, "<color=orange>"..PaperScroll(56,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(56,-1);
	AddItem(256,1);
	AddExp(0,PaperScroll(56,0));
do return end;
::label57::
    Talk(0, "<color=orange>"..PaperScroll(57,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(57,-1);
	AddItem(257,1);
	AddExp(0,PaperScroll(57,0));
do return end;
::label58::
    Talk(0, "<color=orange>"..PaperScroll(58,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(58,-1);
	AddItem(258,1);
	AddExp(0,PaperScroll(58,0));
do return end;
::label59::
    Talk(0, "<color=orange>"..PaperScroll(59,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(59,-1);
	AddItem(259,1);
	AddExp(0,PaperScroll(59,0));
do return end;
::label60::
    Talk(0, "<color=orange>"..PaperScroll(60,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(60,-1);
	AddItem(260,1);
	AddExp(0,PaperScroll(60,0));
do return end;
::label61::
    Talk(0, "<color=orange>"..PaperScroll(61,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(61,-1);
	AddItem(261,1);
	AddExp(0,PaperScroll(61,0));
do return end;
::label62::
    Talk(0, "<color=orange>"..PaperScroll(62,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(62,-1);
	AddItem(262,1);
	AddExp(0,PaperScroll(62,0));
do return end;
::label63::
    Talk(0, "<color=orange>"..PaperScroll(63,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(63,-1);
	AddItem(263,1);
	AddExp(0,PaperScroll(63,0));
do return end;
::label64::
    Talk(0, "<color=orange>"..PaperScroll(64,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(64,-1);
	AddItem(264,1);
...
do return end;
::label67::
    Talk(0, "<color=orange>"..PaperScroll(67,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(67,-1);
	AddItem(267,1);
	AddExp(0,PaperScroll(67,0));
do return end;
::label68::
    Talk(0, "<color=orange>"..PaperScroll(68,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(68,-1);
	AddItem(268,1);
	AddExp(0,PaperScroll(68,0));
do return end;
::label69::
    Talk(0, "<color=orange>"..PaperScroll(69,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(69,-1);
	AddItem(269,1);
	AddExp(0,PaperScroll(69,0));
do return end;
::label70::
    Talk(0, "<color=orange>"..PaperScroll(70,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(70,-1);
	AddItem(270,1);
	AddExp(0,PaperScroll(70,0));
do return end;
::label71::
    Talk(0, "<color=orange>"..PaperScroll(71,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(71,-1);
	AddItem(271,1);
	AddExp(0,PaperScroll(71,0));
do return end;
::label72::
    Talk(0, "<color=orange>"..PaperScroll(72,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(72,-1);
	AddItem(272,1);
	AddExp(0,PaperScroll(72,0));
do return end;
::label73::
    Talk(0, "<color=orange>"..PaperScroll(73,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(73,-1);
	AddItem(273,1);
	AddExp(0,PaperScroll(73,0));
do return end;
::label74::
    Talk(0, "<color=orange>"..PaperScroll(74,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(74,-1);
	AddItem(274,1);
	AddExp(0,PaperScroll(74,0));
do return end;
::label75::
    Talk(0, "<color=orange>"..PaperScroll(75,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(75,-1);
	AddItem(275,1);
	AddExp(0,PaperScroll(75,0));
do return end;
::label76::
    Talk(0, "<color=orange>"..PaperScroll(76,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(76,-1);
	AddItem(276,1);
	AddExp(0,PaperScroll(76,0));
do return end;
::label77::
    Talk(0, "<color=orange>"..PaperScroll(77,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(77,-1);
	AddItem(277,1);
	AddExp(0,PaperScroll(77,0));
do return end;
::label78::
    Talk(0, "<color=orange>"..PaperScroll(78,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(78,-1);
	AddItem(278,1);
	AddExp(0,PaperScroll(78,0));
do return end;
::label79::
    Talk(0, "<color=orange>"..PaperScroll(79,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(79,-1);
	AddItem(279,1);
	AddExp(0,PaperScroll(79,0));
do return end;
::label80::
    Talk(0, "<color=orange>"..PaperScroll(80,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(80,-1);
	AddItem(280,1);
	AddExp(0,PaperScroll(80,0));
do return end;
::label81::
    Talk(0, "<color=orange>"..PaperScroll(81,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(81,-1);
	AddItem(281,1);
	AddExp(0,PaperScroll(81,0));
do return end;
::label82::
    Talk(0, "<color=orange>"..PaperScroll(82,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(82,-1);
	AddItem(282,1);
	AddExp(0,PaperScroll(82,0));
do return end;
::label83::
    Talk(0, "<color=orange>"..PaperScroll(83,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(83,-1);
	AddItem(283,1);
	AddExp(0,PaperScroll(83,0));
do return end;
::label84::
    Talk(0, "<color=orange>"..PaperScroll(84,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(84,-1);
	AddItem(284,1);
	AddExp(0,PaperScroll(84,0));
do return end;
::label85::
    Talk(0, "<color=orange>"..PaperScroll(85,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(85,-1);
	AddItem(285,1);
	AddExp(0,PaperScroll(85,0));
do return end;
::label86::
    Talk(0, "<color=orange>"..PaperScroll(86,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(86,-1);
	AddItem(286,1);
	AddExp(0,PaperScroll(86,0));
do return end;
::label87::
    Talk(0, "<color=orange>"..PaperScroll(87,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(87,-1);
	AddItem(287,1);
	AddExp(0,PaperScroll(87,0));
do return end;
::label88::
    Talk(0, "<color=orange>"..PaperScroll(88,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(88,-1);
	AddItem(288,1);
	AddExp(0,PaperScroll(88,0));
do return end;
::label89::
    Talk(0, "<color=orange>"..PaperScroll(89,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(89,-1);
	AddItem(289,1);
	AddExp(0,PaperScroll(89,0));
do return end;
::label90::
    Talk(0, "<color=orange>"..PaperScroll(90,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(90,-1);
	AddItem(290,1);
	AddExp(0,PaperScroll(90,0));
do return end;
::label91::
    Talk(0, "<color=orange>"..PaperScroll(91,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(91,-1);
	AddItem(291,1);
	AddExp(0,PaperScroll(91,0));
do return end;
::label92::
    Talk(0, "<color=orange>"..PaperScroll(92,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(92,-1);
	AddItem(292,1);
	AddExp(0,PaperScroll(92,0));
do return end;
::label93::
    Talk(0, "<color=orange>"..PaperScroll(93,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(93,-1);
	AddItem(293,1);
	AddExp(0,PaperScroll(93,0));
do return end;
::label94::
    Talk(0, "<color=orange>"..PaperScroll(94,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(94,-1);
	AddItem(294,1);
...
do return end;
::label129::
    Talk(0, "<color=blue>"..PaperScroll(129,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(129,-1);
	AddExp(0,PaperScroll(129,0));
do return end;
::label183::
    Talk(0, "<color=blue>"..PaperScroll(183,1).."</color>留着也没用了，一把火烧了才干净！");
	AddItem(183,-1);
