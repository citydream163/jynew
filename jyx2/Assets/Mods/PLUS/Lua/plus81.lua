...
Talk(12, "还是你这只蝙蝠飞的快，比我这老鹰先一步到达。", "", 0);
Talk(14, "哪里，哪里，鹰王承让了。六大派似乎已经攻进去了，这小子大概是后援的人手，我们先将他拿下再说吧。", "", 0);
Talk(12, "好啊！先暖暖我这把老骨头也好。", "", 0);
Talk(0, "不是，不是，我是来帮…………", "", 1);
Talk(12, "帮六大派的！我明教才不怕你们这些自居名门的家伙。", "", 0);
if TryBattle(11) == true then goto label0 end;
    Dead();
    do return end;
::label0::
    LightScence();
    Talk(14, "可恶，爪子真硬，鹰王，我们先进去再说。", "", 0);
    ...
    Talk(8, "魔教已然一败涂地，再不投降，还待怎的？<color=Yellow>玄慈</color>大师，咱们这便去毁了魔教三十三代教主的牌位吧！", "", 0);
    Talk(7, "什么投不投降？魔教之众，今日不能留下任何活口。除恶务尽，否则他日死灰复燃，又将为害江湖。魔崽子们！识时务的快快自我了断，省得大爷们动手。", "", 0);
    Talk(70, "<color=Red>华山派</color>和<color=Red>崆峒派</color>各位，请将顶上的魔教余孽一概诛灭了。<color=Red>武当派</color>从西往东搜索，<color=Red>峨嵋派</color>从东往西搜索，别让魔教有一人漏网。", "", 0);
