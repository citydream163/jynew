Talk(85, "这位少侠，上泰山来不知有何见教？", "", 0);
Talk(0, "原来这儿就是泰山啊，古人曾说过“登泰山而小天下”，今日一见果然名不虚传。", "", 1);
Talk(85, "好说，好说。我<color=Red>泰山派</color>立派以来，每年上山朝拜者数以万计，多少人都想到我<color=Red>泰山派</color>拜师学艺。我看，你也是想来这拜师的吧？", "", 0);
Talk(0, "哈！哈！我还需要拜师？有没有搞错啊！我看你拜我为师还差不多。不然这样好了，今儿个我心情正好，就收你为徒。咱们也不必行什么拜师礼了……", "", 1);
Talk(85, "小子！好大的口气！我倒要看看你有多少斤两，想叫我拜你为师！", "", 0);
Talk(0, "那你就试试看！", "", 1);
