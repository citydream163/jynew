Talk(0, "哇！这里这么多人，干什么这么热闹，可少不了小侠我。我说名门正派又怎么样，还不是一样赶尽杀绝，跟魔教又有什么两样，只不过藉口好听一点罢了。", "", 1);
Talk(14, "都是你这个兔崽子，打伤了鹰王和我，", "", 0);
Talk(11, "还有我。", "", 0);
Talk(14, "害我们只剩下范右使应战，寡不敌众……", "", 0);
Talk(0, "既然如此，我就帮你们打发这些人，当是陪罪好了。", "", 1);
Talk(70, "少侠非魔教人士，还请速速离去，以免受池鱼之殃。", "", 0);
Talk(0, "那好，大家都别打了，因为这中间着实有许多误会，让我好好说给你们听。", "", 1);
Talk(6, "现在年轻人都这么狂妄吗？你自以为是武林盟主吗！要我们听你说。", "", 0);
Talk(8, "你这小贼，跟魔教勾结，想要拖延时间，好施什么诡计么？先杀了你再说。", "", 0);
Talk(0, "我就知道要你们安安静静听我说是不太可能，那只有想办法让你们服气了。一起来吧，这样比较省事。", "", 1);
Talk(6, "好狂妄的口气。", "", 0);
Talk(70, "阿弥陀佛。", "", 0);
...
::label0::
    ...
    LightScence();
    Talk(0, "如何？现在肯安静地听我说了吧。事情的经过是这样的……如此如此…………这般这般…………总之，一切的阴谋，都是<color=Yellow>成昆</color>那奸贼所计划的。所以我说呢，你们两方还是握手言和吧，反正明教杀过六大派的人，六大派也杀过明教的人，大家半斤八两，差不了多少，就都罢手吧。", "", 1);
    Talk(8, "话都是你在说的，是不是真的，我们怎么知道。", "", 0);
    Talk(6, "哼！技不如人，说这么多做什么，走吧！", "", 0);
    Talk(70, "阿弥陀佛，盼少侠以后多所规劝引导，总要使明教改邪归正，少做坏事。我们走吧。", "", 0);
    ...
    Talk(14, "小子，你还不赖嘛！", "", 0);
    Talk(10, "蝠王，不可无礼。明教全教下上，叩谢少侠护教救命的大恩！", "", 0);
    Talk(0, "快别这么说，仗义行侠，本就是我辈中人应当做的。况且，这次也因为我的鲁莽，害你们陷入苦战。", "", 1);
    Talk(12, "哪里，是我们没问清楚。", "", 0);
    Talk(14, "你们也别这么客套了。这样吧，大家听我一言，我说呢，这位少侠武功盖世义薄云天，于本教有存亡续绝的大恩。咱们拥立他为本教第三十四任教主。由他来做教主，总比你来做教主好吧，杨左使，你说对不对啊。", "", 0);
    Talk(11, "是啊！这位少侠来做我们教主，也比你<color=Yellow>韦一笑</color>来做好的多。", "", 0);
    Talk(14, "你……", "", 0);
    Talk(10, "你们两个别在那里吵了，丢人现眼的。", "", 0);
    Talk(0, "不，不，在下我虽然一直梦想能当个什么掌门教主的。但是我仍有要事在身，且跟你们是不同世界的人，所以你们还是另觅他人吧。", "", 1);
    Talk(10, "少侠如果一直推却不肯，我们明教恐怕又要为此争闹不休，四分五裂，到时又会被其他门派围攻，导致灭亡了。", "", 0);
    Talk(0, "我这里有封阳教主的遗书，上面提到要<color=Yellow>谢逊</color>谢法王暂代教主之职。我想你们还是先找到他再说吧。", "", 1);
    Talk(10, "哦！真是如此，来人啊！即刻通令下去，全力寻找谢法王。", "", 0);
    Talk(0, "另外还有一件事拜托你们，你们明教中是否有一本叫《<color=#A564DB>倚天屠龙记</color>》的书？是否能借我一下。", "", 1);
    Talk(10, "有的。阳教主曾对我提过，我们教中有一本奇书，是我明教镇教之宝，皆由历代教主相传而下。", "", 0);
    Talk(0, "是吗？真的有。皇天不负苦心人，打了这么多场仗，终于让我找到了。", "", 1);
    Talk(10, "可是，这本书因为阳教主的突然消失，其下落也无人知晓了。", "", 0);
    Talk(12, "少侠别担心，等我们找到谢法王，整顿好教务后，必当全力搜寻此书的下落。若有消息，定当告之少侠。", "", 0);
    Talk(0, "好吧，也只有这样了。我有空也会帮你们找找谢前辈，在下这就告辞了。", "", 1);
    Talk(10, "这里有块<color=blue>铁焰令</color>，是我明教的信物。少侠在江湖上行走，若有什么困难需要我明教帮忙的时候，只须出示这块<color=blue>铁焰令</color>，我明教全体教众一定全力相助。", "", 0);
    AddItem(190, 1);
    AddEthics(10);
    AddRepute(15);
	ModifyEvent(12, 15, 1, 1, 2019, -1, -1, -2, -2, -2, -2, -2, -2);--by citydream启动脚本-2019改变对话。场景12-15
do return end;
