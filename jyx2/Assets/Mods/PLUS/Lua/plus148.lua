Talk(6, "魔教妖邪，来我峨嵋山有何贵事。", "", 0);
Talk(0, "上回看你手中那把宝剑，寒芒吞吐，电闪星飞，想必就是传说中的“<color=#F8413E>倚天剑</color>”？小侠我想向你借来用用。", "", 1);
Talk(6, "<color=Red>光明顶</color>上被你侥幸获胜，你现在还敢来我峨嵋撒野，莫非真视我峨嵋无人。", "", 0);
if AskBattle() == true then goto label0 end;
    Talk(0, "哪里，哪里。我只不过是来劝师太，与明教间的事能和就和。自古以来冤家宜解不宜结。", "", 1);
    Talk(6, "阁下未免管的太多了吧，难道你真以为你是“武林盟主”吗！", "", 0);
    do return end;
::label0::
...
::label1::
        LightScence();
        Talk(0, "宝剑还是应该配英雄，怎样？师太，这“<color=#F8413E>倚天剑</color>”可以让给我了吧。", "", 1);
        Talk(6, "魔教妖孽，想从我<color=Yellow>灭绝</color>手中拿走<color=#F8413E>倚天剑</color>，等下辈子吧！", "", 0);
        ...
        Talk(77, "师父，师父！", "", 0);
        Talk(0, "师太，师太！何苦如此呢？若真不想给我，跟我说一声就行了。唉！", "", 1);
        Talk(6, "魔教的淫徒，你若玷污了我爱徒们的清白，我做鬼也不饶过…………你！", "", 0);
        Talk(77, "师父，师父！可恶的魔教妖邪，替我师父偿命来。", "", 0);
