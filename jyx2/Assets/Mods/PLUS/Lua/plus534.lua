Talk(52, "公子是否有破解这“珍珑”的方法了？", "", 0);
if InTeam(49) == true then goto label0 end;
    Talk(0, "晚辈棋力不佳，否则我倒也想试一试。", "", 1);
    Talk(52, "可惜，可惜，难道世上无人能解开此“珍珑”吗？", "", 0);
    do return end;
::label0::
    Talk(0, "晚辈棋力不佳，不过我试试看好了。", "", 1);
    Talk(52, "公子请。", "", 0);
    DarkScence();
    LightScence();
    Talk(0, "嗯……前去无路，后有追兵，正也不是，邪也不是，那可难也！……＜咦，棋局上的白子黑子似乎都化做了各派高手，东一堆使剑，西一堆使拳，你围住我，我围住你，互相纠缠不清的厮杀……我方白色的人马被黑色各派高手给围住了，左冲右突，始终杀不出重围……＞难道我天命已尽，一切枉费心机了。", "", 1);
	Talk(0, "我这样努力的找寻“十四天书”，终究要化作一场梦！时也命也，夫复何言？我不如死了算了。", "", 1);
    jyx2_ReplaceSceneObject("", "NPC/xuzhu", "1");--虚竹
    Talk(49, "不可如此！＜大哥似乎入魔障了，怎么办？有了，我解不开这棋局，但捣乱一番，让他心神一分，便有救了……＞我来解这棋局。嗯！就下在这里好了。", "", 1);
    Talk(52, "胡闹，胡闹，你自填一气，自己杀死一块白棋，哪有这等的下法。", "", 0);
    Talk(0, "咦！难道竟是这样？前辈你看，白棋故意挤死了一大块后，接下来就好下多了。", "", 1);
    Talk(52, "这……这……这“珍珑”竟然解了，原来关键在于第一着的怪棋。这局棋原本纠缠于得失胜败之中，以至无可破解，小和尚这一着不着意于生死，更不着意于胜败，反而勘破了生死，得到解脱……", "", 0);
    Talk(49, "小僧棋艺低劣，胡乱下子，志在救人……", "", 1);
    Talk(0, "贤弟误打误撞，反而收其效果。", "", 1);
    Talk(52, "神僧天赋英才，可喜可贺。请入屋内。", "", 0);
    Talk(49, "这……", "", 1);
    Talk(0, "贤弟就进去吧。搞不好老前辈要发奖品给你呢。", "", 1);
    DarkScence();
