Talk(0, "老婆婆，这岛很美，您一个人住着吗？", "", 1);
Talk(15, "小子，来我岛上寻晦气的吗？", "", 0);
Talk(0, "没的事，我只是四处旅游，无意间来到这岛上的。", "", 1);
Talk(15, "说实话，你是哪一派的弟子？到这岛上来做什么？", "", 0);
Talk(0, "我无门无派，无师自通，自己四处“练练功”罢了。", "", 1);
Talk(15, "自已四处练练？那好，我老太婆就来陪你玩玩。", "", 0);
if AskBattle() == true then goto label0 end;
    ModifyEvent(-2, -2, -2, -2, 99, -1, -1, -2, -2, -2, -2, -2, -2);
    do return end;
::label0::
    Talk(0, "好啊！闲来无事，就跟您老人家练练功增加些经验点数吧。", "", 1);
