if InTeam(51) == false then goto label0 end;
    Talk(51, "等一下！", "", 0);--对话显示在上方
::label0::
    if InTeam(51) == true then goto label1 end;
        Talk(51, "等一下！", "", 1);--对话显示在下方
::label1::
        DarkScence();
...
::label5::
                        LightScence();
                        Talk(0, "慕容公子，你要做什么？", "", 1);
                        Talk(51, "我决定今天要在武林同道面前揭发<color=Yellow>乔峰</color>真实的身份……", "", 0);
                        Talk(0, "慕容公子，得饶人处且饶人。", "", 1);
                        Talk(51, "哼！你得到书了，而我呢？大燕复国的希望都在我身上……", "", 0);
                        Talk(0, "那，恕在下得罪了。", "", 1);
...
::label6::
                            LightScence();
                            Talk(0, "慕容公子，我不杀你，这件事还请你忘记，否则……", "", 1);
                            Talk(51, "哼！", "", 0);
                            AddRepute(3);
                            AddEthics(3);
                            DarkScence();
...
::label7::
                                ...
                                if JudgeScenePic(-2, 23, 6298, 1, 0) then goto label8 end;--如果前面显示王语嫣，跳转label8
                                    do return end;
::label8::
                                    Talk(0, "王姑娘，你怎么还在这，你表哥已经走了。", "", 1);
                                    Talk(109, "唉！我表哥为了大燕复国之事，已经发疯了。在他一生之中，便是梦想要做大燕皇帝。这也难怪，因为他慕容氏世世代代，做的便是这个梦。他祖宗几十代做下来的梦，传到他身上，怎又能盼他觉醒呢？我表哥他本性并不坏，只不过为了想做大燕皇帝，行事才会变得如此不择手段……", "", 0);
                                    Talk(0, "可是你不是一直都喜欢着他吗……", "", 1);
                                    Talk(109, "在我表哥心中，复兴大业一直都是他心中最重要的事，儿女私情只不过……", "", 0);
                                    if JudgeScenePic(-2, 24, 6314, 46, 0) then goto label9 end;--如果上面显示段誉跳转label9
                                        Talk(0, "王姑娘，你别烦恼，或许过阵子你表哥就会想通了。", "", 1);
                                        Talk(109, "希望如此。那我先回<color=Red>燕子坞</color>了。公子，告辞！", "", 0);
                                        DarkScence();
...
::label10::
                                            ...
                                            do return end;
::label9::
                                            Talk(53, "王姑娘，你别烦恼，我去劝劝你表哥，让他对你好一点……", "", 0);
                                            Talk(109, "段公子，我真是糊涂透顶，你一直待我这么好，我……我却……直到此刻我方才明白，这世上谁才是真的爱我，怜我的人…………", "", 0);
                                            Talk(0, "恭喜段兄，真心终于打动了美人芳心。不知二位今后有何打算？", "", 1);
                                            Talk(109, "我曾听段郎说，<color=Red>无量山洞</color>中有一玉像，像极了我。我想先和段郎去那一游。", "", 0);
                                            Talk(0, "那，祝你们一路顺风了。", "", 1);
                                            Talk(53, "兄弟，你也保重。", "", 0);
                                            DarkScence();
...
::label12::
                                                    ...
                                                    LightScence();
                                                    Talk(0, "别人都已有情人终成眷属，而我呢？唉！别想这么多了，走吧！", "", 1);
                                                    AddEthics(5);
                                                    do return end;
do return end;
