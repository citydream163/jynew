...
if AskBattle() == true then goto label0 end;
    do return end;
::label0::
    Talk(0, "什么<color=Red>恒山派</color>禁地，土地权状拿出来我瞧瞧。像你们这样据地称王的人，我最痛恨了。", "", 1);
    Talk(83, "这位施主，再不离开，可别怪我们不客气！", "", 0);
    Talk(0, "我从地理课本上知道，恒山风光明媚，鸟语花香，而见性峰更是如人间仙境。因此我特地上来观光的，你们这些臭道姑太不讲道理了。老子我就偏要看看这见性峰到底长什么样！你们能奈我何！", "", 1);
    Talk(83, "小子说什么！我看你是<color=Red>嵩山派</color>派来的奸细吧！快滚回去告诉你们掌门，<color=Red>恒山派</color>绝不会答应并派的！", "", 0);
    Talk(0, "说什么五四三的，听呒啦。小侠我都甘愿冒着“一见尼姑，逢赌必输”的大险来到你们这尼姑庵中，怎可败兴而归。", "", 1);
    Talk(83, "胡说八道的小子，先拿下再说。", "", 0);
...
::label1::
        ...
        LightScence();
        Talk(0, "哼！愈是不让我来，我就愈想探个究竟。", "", 1);
        AddRepute(1);
		ModifyEvent(-2, 40, -2, -2, 2068, -1, -1, -2, -2, -2, -2, -2, -2);--by citydream 启动脚本2068 场景31-40
do return end;
