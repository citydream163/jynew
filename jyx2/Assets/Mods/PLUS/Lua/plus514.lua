...
LightScence();
Talk(51, "怎么，方丈后悔了？", "", 1);
Talk(70, "老衲想通了，既造业因，便有业果。自己的名声固然重要，但是我亏欠<color=Yellow>乔峰</color>一家人实在太多了，我不能再让你去害他。", "", 0);
Talk(51, "方丈这是做什么，今天我去揭发<color=Yellow>乔峰</color>，是为武林除害。", "", 1);
Talk(70, "是吗？依老衲看，是为了你大燕复国的计划吧。其实我早就该想到了，当初就是你父亲慕容博施主，假传音讯，说是契丹武士要大举侵犯少林夺取武学典籍，才会酿成大错。这一切，都是你父亲要挑起汉辽武人相斗，使你大燕从中取利。", "", 0);
Talk(51, "……", "", 1);
Talk(70, "快将信件留下。", "", 0);
Talk(51, "方丈不怕我将你的事也揭露出来。", "", 1);
Talk(70, "我个人事小，中原武林的和谐才重要，我不能让你利用此信，引起武林的大风暴。", "", 0);
Talk(51, "好，你别怪我。这事传出去后，看你<color=Red>少林寺</color>的脸往哪里摆。一个堂堂的少林方丈和女人乱来，还生下了一名私生子……", "", 1);
Talk(0, "有这等事？", "talkname0", 1);
Talk(70, "阿弥陀佛！老衲是犯了佛门大戒，待将你们拿下，取回信件后，老衲自会自我惩处。", "", 0);
Talk(51, "看来免不了一战了。", "", 1);
