...
Talk(3, "你们是田归农请来的吧！<color=Red>神龙教</color>何时跟田归农搭在一起了。", "", 0);
Talk(97, "还多亏了田兄，我们才知道《<color=#A564DB>飞狐外传</color>》一书在你这。识相的话就快将书交出来。", "", 0);
Talk(3, "田归农呢？他怎么不敢出来见我。", "", 0);
Talk(97, "我看你是见不到他了。田兄从<color=Yellow>毒手药王</color>那弄来的断肠草粉末，药效也真够狠。现下你双眼已瞎，我看“打遍天下无敌手”的金面佛<color=Yellow>苗人凤</color>，今日要上西天了！兄弟们，上！", "", 0);
...
::label0::
    ...
    LightScence();
    Talk(3, "小兄弟，你尊姓大名，与我可有渊源？", "", 0);
    Talk(0, "丈夫结交，但重义气，只需肝胆相照，何必提名道姓。", "", 1);
    Talk(3, "好，<color=Yellow>苗人凤</color>独来独往，生平只有两个知交，一个是辽东大侠胡一刀，另一个便是你这位不知姓名没见过面的小兄弟。", "", 0);
    if InTeam(1) == false then goto label1 end;
        Talk(1, "你说什么。那你为何要杀死胡大侠。", "", 1);
        Talk(3, "这说来话长……", "", 0);
        Talk(0, "大哥，我们先想办法救苗大侠，这事以后再说。", "", 1);
::label1::
        Talk(0, "苗大侠，既然这药是<color=Yellow>毒手药王</color>所配制，那我们去求<color=Yellow>毒手药王</color>救治，或能解得。", "", 1);
        Talk(3, "要求<color=Yellow>毒手药王</color>吗？那是徒劳往返，不用去了。", "", 0);
        Talk(0, "不，天下无难事！这位<color=Yellow>毒手药王</color>住在哪里？", "", 1);
        Talk(3, "听说此人在洞庭湖畔隐居。", "", 0);
        Talk(0, "我这就去了！", "", 1);
