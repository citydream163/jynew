...
Talk(0, "四位那么好的闲情逸致聚在这儿，是不是准备打麻将，插花收不收啊？", "", 1);
Talk(33, "你这臭小子，看你做了什么好事？还敢在这说风凉话。", "", 0);
Talk(34, "我早该知道天底下哪有这么好的事情，原来这一切都是你设计出来的诡计。", "", 0);
Talk(32, "你这小子，竟然利用我们所好，实在太可恶了。", "", 0);
Talk(0, "你们在那你一言我一句的，唱双簧啊！", "", 1);
Talk(32, "小子，你真是太大胆了，竟敢把任老怪给放了，看我饶不饶你！", "", 0);
Talk(0, "喂！喂！你们在说什么啊？我还没说你们偷走我那四样宝物，你们就恶人先告状。真是岂有此理，什么态度嘛……况且我哪有放走任前辈……", "", 1);
Talk(33, "大哥，别跟这小子啰嗦了，此时再也顾不得什么以老欺小的狗屁道义了。先将这小子捉上<color=Red>黑木崖</color>，向东方教主请罪，否则咱们可就吃不完兜着走了。", "", 0);
Talk(34, "好，咱们一起上。", "", 0);
Talk(0, "谁怕谁！乌龟怕铁锤！四个一起上最好，省得我麻烦。", "", 1);
Talk(31, "小子你找死！", "", 0);
...
::label0::
    LightScence();
    Talk(32, "小子，你可知你放走的是谁？", "", 0);
    Talk(0, "他不是你们请来的打手吗？", "", 1);
    Talk(31, "你是真不知还是假不知，你放走了任老怪，就是与东方教主和我日月神教为敌。", "", 0);
    Talk(0, "你们是日月神教的？", "", 1);
    Talk(33, "不错，我们是奉教主之命，在此看守任老怪的，你居然利用我们的弱点救他出去。", "", 0);
    Talk(34, "别说了，得赶紧回<color=Red>黑木崖</color>向东方教主报告这件事。走！", "", 0);
    DarkScence();
