...
Talk(19, "承蒙各位看得起我华山派，每年都选择在我华山齐聚，举办这武林大会。今年岳某特别邀请到少林寺住持玄慈大师，前来此处主持今年的“华山论剑”。", "", 0);
Talk(70, "阿弥陀佛！承蒙大家看得起我玄慈，今年就由我来为各位服务。今年还是和往年一样，受到邀请前来华山的各位英雄，都有机会成为新一任的武林盟主，获得保管“神杖”的资格。现在，我宣布大会开始，只要愿意，谁都可出来比试，直到无人挑战为止。", "", 4);
Talk(19, "不知哪位英雄要先出来接受挑战？……似乎没有人愿意先出来？……", "", 0);
...
for j = 1, #Dict_arr do
    ...
    Talk(0,"…………","", 1);
    Talk(0,"没有人了吗？","", 1);
    Talk(70,"如果还没有人要出来向这位少侠挑战，那么这武功天下第一之名，武林盟主之位，就由这位少侠夺得。","", 0);
    Talk(70,"………………","", 0);
    Talk(70,"好，恭喜少侠，这武林盟主之位就由少侠获得，而这把“武林神杖”也由你保管。","", 0);
    Talk(12,"恭喜少侠！","", 0);
    Talk(64,"小兄弟，恭喜你！","", 0);
    Talk(19,"好，今年的武林大会到此已圆满结束，希望明年各位武林同道能再到我华山一游。","", 0);
    DarkScence();
    jyx2_ReplaceSceneObject("","NPC/华山弟子","");
    jyx2_ReplaceSceneObject("","NPC/battleNPC","");
    LightScence();
    Talk(0,"历经千辛万苦，我终于打败群雄，得到这武林盟主之位及神杖。但是“圣堂”在哪呢？为什么没人告诉我，难道大家都不知道。这会儿又有的找了。","", 1);
    AddItem(143,1);
