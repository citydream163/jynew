if UseItem(179) == true then goto label0 end;
    do return end;
::label0::
    Talk(32, "张旭三杯草圣传，脱帽露顶王公前，挥毫落纸如云烟。这……这是真迹！真是……真是唐朝……唐朝张旭的“率意帖”……假不了，假不了的！", "", 0);
    Talk(0, "三庄主果然是行家。", "", 1);
    Talk(32, "少侠，可否再借老夫一看？", "", 0);
    Talk(0, "秃老头，要看可以，先打赢我再说。", "", 1);
    Talk(32, "说什么？我最痛恨人家叫我秃子，你这小子太不知死活了。", "", 0);
    Talk(0, "秃头、秃头，下雨不愁，人家有伞，我有秃头。", "", 1);
    Talk(32, "好小子，我瞧你是活得不耐烦了，看看老夫怎么收拾你。", "", 0);
    if TryBattle(44) == true then goto label1 end;
        Dead();
        do return end;
::label1::
        LightScence();
        Talk(32, "小伙子，果然有两下子，可是那“率意帖”我是要定了。", "", 0);
        Talk(0, "三庄主，别自不量力了。我看这<color=Red>梅庄</color>之中也没什么能手了，真是害我白走一趟。", "", 1);
        Talk(32, "臭小子！别这么嚣张！", "", 0);
        Talk(0, "这样好了，贵庄中只要有人能够胜得了我，连同先前那幅“溪山行旅图”和这“率意帖”一并送上。", "", 1);
        Talk(32, "小子，此话当真？", "", 0);
        Talk(0, "小爷我从来不说假话。", "", 1);
        Talk(32, "好！四弟，咱们去求二哥帮忙。", "", 0);
        DarkScence();
