Talk(0, "喂！就是你要跟我较量较量吗？是的话就快动手，我可没那么多时间和你穷蘑菇。", "", 1);
Talk(26, "你是谁？到这里来大小声的干什么？", "", 0);
Talk(0, "你还问我是谁，我就是打败“梅庄四友”的那个少年英雄。听二庄主<color=Yellow>黑白子</color>说，你因为崇拜我的武功了得，想跟我较量较量，不是吗？", "", 1);
Talk(26, "哈！哈！看你年纪轻轻，竟如此狂妄，不错！不错！我喜欢。你说你打败<color=Red>梅庄</color>那四个窝囊废，当真？", "", 0);
Talk(0, "当然是真的，怀疑啊！", "", 1);
Talk(0, "你还真奇怪，竟然把自己关在这不见天日的地洞，有病啊！还是受了什么刺激？", "", 1);
Talk(26, "把自己关在这？我<color=Yellow>任我行</color>会把自己关在这地牢之中？", "", 0);
Talk(0, "＜<color=Yellow>任我行</color>？<color=Yellow>任我行</color>？这名字好像在哪听过。＞难道任前辈是被囚禁在这？", "", 1);
Talk(26, "说来惭愧，我堂堂日月神教教主竟会被困在这儿。", "", 0);
Talk(0, "＜这老头是日月神教教主？怎么看都不像啊！＞", "", 1);
Talk(26, "要不是当年我潜心修习一门武功大法，将教中的所有大权交给<color=Yellow>东方不败</color>。", "", 0);
Talk(26, "不料那<color=Yellow>东方不败</color>狼子野心，表面上对我十分恭敬，什么事都不敢违背，暗中却培植一己势力，假借诸般藉口，将所有忠于我的部属或是撤革，或是处死，数年之间，我的亲信竟然凋零殆尽。他见时机成熟，竟趁我练功入关之际，干下叛逆篡位之事，并把我关在这西湖之底！", "", 0);
Talk(0, "竟有如此狼心狗肺的家伙，不要让我遇上，不然一定要给他好看。", "", 1);
Talk(26, "哈！哈！哈！就凭你，哈……！", "", 0);
Talk(0, "啊…………", "", 1);
...
Talk(0, "可恶的老头，竟趁我不备偷袭……啊！我的宝物！我上当了！一定是那四个卑鄙狗贼，明的打不过我，来阴的。真是太无耻下流了。", "", 1);
Talk(0, "这是什么鬼地方？奇怪？方才那老家伙突然一阵吼声……喔！一定是那四个狗贼，明的打不过我，来暗的。真是太无耻下流了。咦？这门没关，又不像是要把我关在这儿。嗯，真是可疑？看来可得好好的“瞧瞧”这个鬼地方！", "", 1);
jyx2_StopTimeline("[Timeline]ka37_药王山庄_苏醒");
