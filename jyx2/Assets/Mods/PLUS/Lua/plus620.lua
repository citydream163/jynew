Talk(112, "这位少侠，远道而来，不知有何贵事。", "", 0);
Talk(0, "＜哇！这马子正点＞哦！没什么事，我等旅游各地，为的是找几本书，路过这里，想进来碰碰运气。不过刚刚进来时，好像听他们在讲，你们也在找书，叫什么……", "", 1);
Talk(112, "是我回族圣物<color=blue>可兰经</color>。此书是本族祖传之物，得自回教圣地麦加，数十代都是由首领珍重保管，乃本族圣物。不料前些日子<color=Yellow>金轮法王</color>趁我父亲远出之际，竟将经书抢了过去，说要献给朝廷，以此为挟，控制我回人。因此我率领了本族勇士，想从<color=Yellow>金轮法王</color>那儿将经书抢夺回来，但那家伙实在太厉害了，三番两次都被他打了回来。", "", 0);
Talk(0, "是吗？此事包在我身上．我替姑娘将那<color=blue>可兰经</color>要回来。", "", 1);
Talk(112, "少侠若肯帮忙，我<color=Yellow>霍青桐</color>代全族人向少侠谢谢。但还请少侠小心，那和尚功夫厉害的紧。", "", 0);
Talk(0, "＜为你赴汤蹈火在所不惜＞我会小心的。", "", 1);
