...
SetRoleFace(2);
Talk(0, "你就是<color=Yellow>东方不败</color>？＜怎么看起来像个娘们？＞", "", 1);
Talk(33, "小子，<color=Red>梅庄</color>的帐还没跟你算，你还敢上<color=Red>黑木崖</color>来。", "", 0);
Talk(0, "嗨！四位近来过的如何？“麻将”的技术有没有更精进呢？", "", 1);
Talk(27, "啊！你便是到<color=Red>梅庄</color>救走<color=Yellow>任我行</color>的那小子。我早想见你一见，看看是怎样的一位俊俏郎君。哼，依我看也是平平无奇，比起我那莲弟来，可差的远了。", "", 0);
Talk(0, "干嘛？小心得“爱滋”。", "", 1);
Talk(27, "<color=Yellow>黄钟公</color>，我令你们在杭州好好看守着<color=Yellow>任我行</color>，原来你们都在给我玩什么“麻将”。", "", 0);
Talk(34, "小的该死！唉！玩物丧志。都因属下四人沉溺于琴棋书画，给人窥到这老大弱点，定下奸计将那人劫了出去。", "", 0);
Talk(33, "教主文成武德，仁义英明，望教主再给我们四兄弟一个机会，将这小子拿下。", "", 0);
Talk(26, "什么文成武德，仁义英明，<color=Yellow>东方不败</color>，你肉不肉麻啊！", "", 0);
DarkScence();
ModifyEvent(-2, 55, 1, 1, -1, -1, -1, 6078, 6078, 6078, -2, -2, -2);--by fanyu 任我行出场 场景26-编号55
jyx2_ReplaceSceneObject("", "NPC/renwoxing", "1");--任我行出场
LightScence();
Talk(0, "老头子，是你。那天你怎么不敢跟我比划，还暗算我。", "", 1);
Talk(26, "小兄弟，多亏你了。要不是你误打误撞，我<color=Yellow>任我行</color>此刻还在地牢内呢。", "", 0);
if TeamIsFull() == false then goto label0 end;
    Talk(26, "今天你是来抢《<color=#A564DB>笑傲江湖</color>》一书的吧。我来此本是想帮你一把的，但看你人手似乎已然足够，我就在一旁看你们表演吧。", "", 0);
::label0::
    if TeamIsFull() == true then goto label1 end;
        Talk(26, "今天你是来抢《<color=#A564DB>笑傲江湖</color>》一书的吧。我就帮你一把，算是一点谢意。", "", 0);
::label1::
        Talk(0, "你究竟是谁？", "", 1);
        Talk(26, "我是谁，你问这个娘娘腔的家伙好了。<color=Yellow>东方不败</color>，恭喜你练成了“<color=orange>葵花宝典</color>”上的武功。", "", 0);
        Talk(27, "任教主，这部“<color=orange>葵花宝典</color>”是你传给我的。我一直念着你的好处。", "", 0);
        Talk(0, "＜原来他是日月神教的前任教主？＞", "", 1);
        Talk(26, "是吗？因此你将我关在西湖湖底，教我不见天日。", "", 0);
        Talk(27, "我没杀你，是不是？只须我叫江南四友不送水给你喝，你能捱的了十天半月吗？", "", 0);
        Talk(26, "这样说来，你待我还算不错了？", "", 0);
        Talk(27, "正是。我让你在杭州西湖颐养天年。常言道，上有天堂，下有苏杭。西湖风景，那是天下有名的了，孤山<color=Red>梅庄</color>，更是西湖景色绝佳之处。", "", 0);
        Talk(26, "原来你让我在西湖湖底的黑牢中颐养天年。那可要多谢你了。", "", 0);
        Talk(27, "任教主，你待我的种种好处我永远记得。你破格提拔，连年升我职，甚至连本教至宝的“<color=orange>葵花宝典</color>”也传给了我。此恩此德<color=Yellow>东方不败</color>永不敢忘。初时我一心只想做日月神教教主，想什么千秋万载，一统江湖，于是处心积虑的谋你的位，翦除你的羽翼。", "", 0);
		Talk(27, "我初当教主，那可意气风发了，说什么文成武德，中兴圣教，当真是不要脸的胡吹法螺。直到后来修习“<color=orange>葵花宝典</color>”才慢慢悟到了人生妙谛。其后勤修内功，数年之后，终于明白了天人化生，万物滋长的要道。", "", 0);
		Talk(27, "如今，我最羡慕的就是那些青春年少的娇媚女子，如果能易地而处，别说日月神教的教主，就算是皇帝老子，我也不做。", "", 0);
        Talk(0, "你这男扮女装的老旦，真令人恶心。", "", 1);
        Talk(27, "大胆！", "", 0);
...
::label5::
                        ...
                        if InTeam(26) == false then goto label6 end;
                            Leave(26);
::label6::                  Talk(26, "<color=Yellow>东方不败</color>，今日终于……终于教你落在我手里。", "", 0);
                            Talk(27, "任教主，终究是……是……终究是……是我输了。", "", 0);
                            Talk(26, "哈！哈！你这大号，可得改一改罢？", "", 0);
                            Talk(27, "倘若单打独斗，你们是不能打败我的。", "", 0);
                            Talk(26, "不错，你武功比我高，我很是佩服。", "", 0);
                            Talk(0, "阁下武功极高，不愧称得“天下第一”四字，在下十分钦佩。", "", 1);
                            Talk(27, "你二位能这么说，足见男子汉大丈夫气概。唉，冤孽，冤孽，我练了那“<color=orange>葵花宝典</color>”，照着宝典上的秘方，自宫练气，炼丹服药，渐渐的胡子没有了，说话声音变了，性子也变了。我从此不爱女子，把七个小妾都杀了，却……却把全副心意放在莲弟身上。倘若我生为女儿身，那就好了。", "", 0);
							Talk(27, "任教主，你快把我杀了！", "", 0);
                            Talk(26, "我现在不想杀你了，我也找个地方安养你好了。来人啊，把他带下去。", "", 0);
                            Talk(27, "你好狠毒！", "", 0);
                            DarkScence();
                            ModifyEvent(-2, 86, 0, 0, -1, -1, -1, -1, -1, -1, -2, -2, -2);--by fanyu 人物离场 场景26-编号86
                            jyx2_ReplaceSceneObject("", "NPC/dongfangbubai", "");--东方不败离场
                            LightScence();
                            Talk(33, "恭喜教主，今日诛却大逆。从此我教在教主庇荫之下，扬威四海。教主千秋万载，一统江湖。", "", 0);
                            Talk(26, "胡说八道！什么千秋万载？哈！哈！哈！小兄弟，这一役诛奸复位，你实占首功。这本《<color=#A564DB>笑傲江湖</color>》你就拿去吧。江湖上的人以为它是个高深的武功秘笈，其实只不过是本故事书罢了。", "", 0);
                            Talk(26, "要说到真正的武功秘笈，有什么能比得上这本“<color=orange>葵花宝典</color>”呢？可惜，这并不是常人可以练的。", "", 0);
                            Talk(0, "这话怎讲？", "", 1);
                            Talk(26, "这宝典的第一页就注明着，“欲练神功，引刀自宫”，老夫可不会没了脑子，去干这等傻事。哈哈，哈哈……可是宝典上所载的武功实在厉害，任何学武之人，一见之后却不能不动心。", "", 0);
							Talk(26, "<color=Yellow>东方不败</color>，饶你奸诈似鬼，也猜不透老夫传你“<color=orange>葵花宝典</color>”的用意。你野心勃勃，意存拔扈，难道老夫瞧不出来吗？哈哈，哈哈！", "", 0);
                            Talk(0, "＜原来当初任教主以“<color=orange>葵花宝典</color>”传他，当初便没怀善意。＞＜两人尔虞我诈各怀心机＞“<color=orange>葵花宝典</color>”一书，不知任教主能否借在下一看。", "", 1);
                            ...
                            AddEthics(4);
                            AddRepute(21);
							ModifyEvent(2, 3, -2, -2, 2020, -1, -1, -2, -2, -2, -2, -2, -2);--by citydream 启动脚本2020， 场景2-编号3
							jyx2_ReplaceSceneObject("82", "NPC/东方不败", "1");--东方不败出现在梅庄地道
							ModifyEvent(82, 3, -2, -2, 2021, -1, -1, -2, -2, -2, -2, -2, -2);--by citydream 启动脚本2021， 场景82-编号3
do return end;
