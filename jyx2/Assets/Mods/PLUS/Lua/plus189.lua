...
Talk(20, "还请费兄回去告诉左掌门，五岳并派之事，我<color=Red>衡山派</color>是不会答应的。", "", 0);
Talk(84, "莫掌门还请三思，五岳合并之后，对我五岳剑派是大有好处的。到时我五岳派就可和少林、武当各大派相庭抗礼了。", "", 4);
Talk(20, "<color=Red>衡山派</color>百年基业，还不想断送在我<color=Yellow>莫大</color>手里。费兄还请回吧！", "", 0);
Talk(84, "本来我是不想提的，刘师兄此次金盆洗手，是跟魔教有关吧？左盟主已知道其中曲折了，但顾全五岳同盟之情……所以还是请莫掌门三思，届时还望光临嵩山，参加五岳同盟大会。", "", 4);
Talk(20, "送客！", "", 0);
DarkScence();
